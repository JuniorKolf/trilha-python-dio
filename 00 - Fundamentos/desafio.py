...
def criar_usuario(usuarios):
    ...
    if usuario:
        print("\nXXX Usuário já existe com esse CPF! xxx")
        return
    
    nome = input("informe o nome completo: ")
    data_nascimento = input("Informe a data de nascimento (dd-mm-aa): ")
    endereco = input("Informe o seu endereço completo (lougradouro, nro - bairro - cidade/sigla estado):")
...
def criar_conta(agencia, numero_conta, usuarios):
    ...
    print("\nXXX Usuário não encontrado, criação de conta encerrado! XXX")
